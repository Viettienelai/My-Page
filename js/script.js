...
window.addEventListener('scroll', () => {
    ...
    if (scrollY <= SCROLL_PHASE_ONE) {
        ...
        // Giai đoạn 2: Di chuyển container dựa trên scroll
        const additionalScroll = scrollY - SCROLL_PHASE_ONE;
        searchBarContainer.style.top = `${TARGET_TOP + additionalScroll}px`;
    }
});
